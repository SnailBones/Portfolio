	...
	<div class="project">
		...
		<div class="info">
			<!-- <div class="imageContainer">
				...
				<p>
				The worms follow the same basic mechanics as the balls in Cactris. While balls move away from bodies, worms move toward them. In both cases, depth data is blurred, the derivative is taken, the resulting texture acts as a "force" accelerating worms and balls. This texture is visualized as a subtle ring of color surrounding players as they walk across the game. A gaussian blur can be likened to the force of gravity in 2D space or as if players were standing on a trampoline. Where a player stands, the fabric bends down. The derivative operation converts the fabric's elevation into direction, and the worms roll downhill until they settle in a pit where a player is standing.
				</p>
				<p>
