	...
	<div class="project">
		...
		<div class="info">
			<!-- <div class="imageContainer">
				...
				<p><i>King of The Worms</i> combines a classic videogame theme with physical, active play, supported by a network of sensors and projectors. A worm follows each player as they walk across the floor. Players dodge other worms while collecting food to grow their own. Players may aim to defeat their rival worms and remain king, or to cooperate for mutual survival and growth, a playstyle popular among younger players.
				</p>
				<p>The players use no equipment in this game, the only input is depth data from a series of sensors on the ceiling, and the movement of the worms is determined through shader calculations. This was the first game at Electric Playhouse that assigned players to moveable characters, and ensuring reliability proved a considerable challenge.
				</p>
				<p>
				The worms follow the same basic mechanics as the balls in Cactris. While balls move away from bodies, worms move toward them. In both cases, depth data is blurred, the derivative is taken, the resulting texture acts as a "force" accelerating worms and balls. This texture is visualized as a subtle ring of color surrounding players as they walk across the game. A gaussian blur can be likened to the force of gravity in 2D space or as if players were standing on a trampoline. Where a player stands, the membrane bends down. The derivative operation converts the fabric's elevation into direction, and the worms roll downhill until they settle in a pit where a player is standing.
				</p>
				<p>
